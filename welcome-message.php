...
<head>
    ...
    <title>Welcome Message - St. Theresa Catholic Church</title>
    <?php include 'cdn.php'; ?>
    ...
    <section>
        <div class="welcome-message-grid">
            ...
            <div class="welcome-message-text">
                ...
                <p>
                    As we celebrate this significant milestone, we extend our heartfelt gratitude to all who have
                    contributed to the life and legacy of our parish. We also extend a warm invitation to those who
                    are new to our community to become a part of our story, as we continue to grow in faith and love.
                </p>
                <p>
                    Please take the time to explore our website, where you can find more information about our history,
                    our ministries, and our upcoming events. Should you have any questions or wish to connect with our
                    parish, our doors and hearts are always open to you.
                </p>
                <p>
                    May the blessings of the Lord be with you and your families as we embark on this journey of faith
                    together. May the next 75 years be filled with the same spirit of devotion, unity, and love that has
                    defined our parish for generations.
                </p>
            </div>
        </div>
    </section>
